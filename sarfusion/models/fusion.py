...
class OptionalConv(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1, groups=1, bias=True, use_embedding=True):
...
class FusionConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=None, dilation=1, groups=1, bias=True, use_embedding=True):
        super(FusionConv, self).__init__()
        self.optional_rgb = OptionalConv(3, out_channels, kernel_size, stride=1, padding=1, dilation=dilation, groups=groups, bias=bias, use_embedding=use_embedding)
        self.optional_ir = OptionalConv(1, out_channels, kernel_size, stride=1, padding=1, dilation=dilation, groups=groups, bias=bias, use_embedding=use_embedding)
