...
from sarfusion.utils import TryExcept
from sarfusion.utils.dataloaders import exif_transpose, letterbox
from sarfusion.utils.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
                           increment_path, is_notebook, make_divisible, non_max_suppression, scale_boxes,
                           xywh2xyxy, xyxy2xywh, yaml_load)
from sarfusion.utils.plots import Annotator, colors, save_one_box
from sarfusion.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolo.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from sarfusion.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        from sarfusion.export import export_formats
        from sarfusion.utils.downloads import is_url
